    ...
    msvc_link_env_feature = feature(
        ...
        env_sets = [
            env_set(
                ...
                env_entries = [env_entry(key = "LIB", value = "C:\\Program Files (x86)\\Microsoft Visual Studio 14.0\\VC\\LIB\\amd64;C:\\Program Files (x86)\\Windows Kits\\10\\lib\\10.0.17763.0\\ucrt\\x64;C:\\Program Files (x86)\\Windows Kits\\NETFXSDK\\4.6.1\\lib\\um\\x64;C:\\Program Files (x86)\\Windows Kits\\10\\lib\\10.0.17763.0\\um\\x64;")],
            ),
        ],
    )
        ...
        env_sets = [
            env_set(
                ...
                env_entries = [
                    ...
                    env_entry(key = "TMP", value = "C:\\Users\\pcloudy\\AppData\\Local\\Temp"),
                    env_entry(key = "TEMP", value = "C:\\Users\\pcloudy\\AppData\\Local\\Temp"),
                ],
            ),
        ],
